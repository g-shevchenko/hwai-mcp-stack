...
export interface InjectedShape_aeek { area(): number }
class InjectedSquare_aeek implements InjectedShape_aeek { area() { return 1; } }
const _injS_aeek = new InjectedSquare_aeek(); _injS_aeek.area();
