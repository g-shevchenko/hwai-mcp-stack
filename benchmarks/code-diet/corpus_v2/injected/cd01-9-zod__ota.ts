...
export interface InjectedShape_kku1 { area(): number }
class InjectedSquare_kku1 implements InjectedShape_kku1 { area() { return 1; } }
const _injS_kku1 = new InjectedSquare_kku1(); _injS_kku1.area();
