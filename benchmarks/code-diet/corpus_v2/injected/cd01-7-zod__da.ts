...
export interface InjectedShape_7fnc { area(): number }
class InjectedSquare_7fnc implements InjectedShape_7fnc { area() { return 1; } }
const _injS_7fnc = new InjectedSquare_7fnc(); _injS_7fnc.area();
