...
export interface InjectedShape_dtzw { area(): number }
class InjectedSquare_dtzw implements InjectedShape_dtzw { area() { return 1; } }
const _injS_dtzw = new InjectedSquare_dtzw(); _injS_dtzw.area();
