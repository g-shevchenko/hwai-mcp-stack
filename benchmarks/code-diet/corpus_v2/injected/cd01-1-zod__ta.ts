...
export interface InjectedShape_anne { area(): number }
class InjectedSquare_anne implements InjectedShape_anne { area() { return 1; } }
const _injS_anne = new InjectedSquare_anne(); _injS_anne.area();
