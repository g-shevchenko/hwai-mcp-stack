...
export interface InjectedShape_d9su { area(): number }
class InjectedSquare_d9su implements InjectedShape_d9su { area() { return 1; } }
const _injS_d9su = new InjectedSquare_d9su(); _injS_d9su.area();
