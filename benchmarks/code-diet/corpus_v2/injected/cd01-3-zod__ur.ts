...
export interface InjectedShape_5bxp { area(): number }
class InjectedSquare_5bxp implements InjectedShape_5bxp { area() { return 1; } }
const _injS_5bxp = new InjectedSquare_5bxp(); _injS_5bxp.area();
